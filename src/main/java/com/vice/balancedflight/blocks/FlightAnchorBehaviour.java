...
public class FlightAnchorBehaviour extends BlockEntityBehaviour
{
    ...
    public void initialize()
    {
        ...
        FlightAnchorEntity.ActiveAnchors.put(getPos(), getWorld().getBlockState(getPos()).getValue(FlightAnchor.TIER));
    }
    ...
    public void tick()
    {
        ...
        beaconTick(getWorld(), getPos(), (FlightAnchorEntity) blockEntity);
    }

    @Override
    public void lazyTick() {
        BalancedFlight.LOGGER.info("lazy tick");
    }

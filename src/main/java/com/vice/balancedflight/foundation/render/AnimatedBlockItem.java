...
public class AnimatedBlockItem extends AssemblyOperatorBlockItem implements GeoAnimatable
{
    ...
    private final Supplier<Supplier<? extends GeoItemRenderer<?>>> renderer;
